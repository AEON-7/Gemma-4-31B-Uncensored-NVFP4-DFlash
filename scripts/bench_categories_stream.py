...
async def main() -> int:
    ...
    parser.add_argument("--model", default="deckard-31b")
    ...
    print(
        f"Gemma 4 31B category benchmark: model={args.model} max_tokens={args.max_tokens} "
    ...
    output = args.output or f"gemma31-category-bench-{int(time.time())}.json"
